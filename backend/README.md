...
## Project Structure
    ...
    ├── testapiautodatamod_104199  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_104199`
...
2. Clone this repo and `cd testapiautodatamod_104199`
